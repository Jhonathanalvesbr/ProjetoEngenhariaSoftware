...
public class AlunoFrmPrincipal extends javax.swing.JFrame {
     ...
     */
    public AlunoFrmPrincipal() {
        initComponents();
        setExtendedState(MAXIMIZED_BOTH);
        AlunoTelaUsuario frame = new AlunoTelaUsuario();
        chamarFrame(frame);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlunoFrmPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
